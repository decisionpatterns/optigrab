...
*optigrab* simplifies the creation of command-line interfaces. It favors a easy-to-use, straight-forward conventions that covers 99% of use cases over more complex command-line parsing solutions. Mostly, you can just:
...
There are already at least five command-line option ("CLOs") processing 
solutions for R:

- [docopt](https://github.com/docopt/docopt.R) is a popular alternative. *docopt* requires a specification be written -- though the specification is the documentation for the command line program. It is highly configurable, follows a similar paradigm as *optigrab*.   
...
and syntax. It provides a `getopt` that emulates C-like behaviors. Both of these are designed for languages signigicantly different from R. 
