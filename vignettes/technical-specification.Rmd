...
--------  ----------  -------------
script    my_program  called 'script' to emphasize that its by run by a separate interpreter that might be called the program. Have both(?)
verb      command     called 'verb' to clarify ambiguity of "command"; also specifies the type of word used -- sometimes this is called "sub-command"
targets   arguments   called 'targets' since, technically verb, options and targets are all arguments.
